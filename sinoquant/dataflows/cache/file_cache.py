...
class StockDataCache:
    ...
    def __init__(self, cache_dir: str = None):
        ...
        Args:
            cache_dir: 缓存目录路径，默认为 sinoquant/dataflows/data_cache
        """
        ...
        # 创建所有目录
        for dir_path in [self.china_stock_dir, self.china_news_dir,
    ...
    def save_stock_data(self, symbol: str, data: Union[pd.DataFrame, str],
        ...
        Args:
            ...
            start_date: 开始日期
            end_date: 结束日期
            data_source: 数据源（如 "tdx", "akshare", "baostock"）
    ...
    def find_cached_fundamentals_data(self, symbol: str, data_source: str = None,
        ...
        Args:
            symbol: 股票代码
            data_source: 数据源（如 "openai", "akshare"）
            max_age_hours: 最大缓存时间（小时），None时使用智能配置
