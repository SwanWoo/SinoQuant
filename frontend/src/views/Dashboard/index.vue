<template>
  <div class="dashboard">
    ...
    <!-- K线行情图 -->
    <DashboardKlineChart style="margin-bottom: 24px;" />
...
import DashboardKlineChart from '@/components/Dashboard/DashboardKlineChart.vue'
