    ...
    <div class="hero-section">
      <div class="hero-content">
        <div class="hero-text">
          <h1 class="hero-title">
            SinaQuant
            <span class="version-badge">v0.0.0-preview</span>
          </h1>
          ...
          <div class="hero-acknowledgment">
            ...
            <span>基于 <a href="https://github.com/SinoQuant/SinoQuant" target="_blank" rel="noopener noreferrer">SinaQuant</a> 项目开发，感谢原项目的贡献</span>
          </div>
        ...
        <div class="origin-card">
          <div class="origin-header">
            ...
            <div class="origin-info">
              <h3>SinaQuant</h3>
              <a href="https://github.com/SinoQuant/SinoQuant"
                 target="_blank"
                 rel="noopener noreferrer"
                 class="origin-link">
                <el-icon><Link /></el-icon>
                github.com/SinoQuant/SinoQuant
              </a>
            </div>
          </div>
          ...
          <div class="origin-description">
            <p>
              <strong>SinaQuant</strong> 是基于 <strong>SinaQuant</strong> 项目开发的中文本地化版本。
              原项目由 项目团队 团队开发，是一个创新的多智能体股票分析框架。
            </p>
            <p>
            ...
            <p class="origin-thanks">
              <el-icon><Star /></el-icon>
              <strong>特别感谢</strong> 项目团队 团队的开源贡献，为我们提供了优秀的技术基础和设计理念。
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="version-info">
        <div class="version-card">
          <div class="version-main">
            <div class="version-number">v0.0.0-preview</div>
          ...
          <div class="version-details">
            ...
            <div class="version-item">
              ...
              <span class="value">v0.0.0-preview</span>
            </div>
          </div>
        </div>
      ...
      .feature-card {
        ...
        .feature-header {
          ...
          .feature-icon {
            ...
            &.primary {
              background: linear-gradient(135deg, var(--el-color-primary), #42b983);
            }
    ...
    .origin-content {
      ...
      .origin-card {
        ...
        &::before {
          ...
          right: 0;
          height: 4px;
          background: linear-gradient(90deg, #42b983, #369a6d);
        }
        ...
        .origin-header {
          ...
          .origin-icon {
            ...
            height: 64px;
            border-radius: 16px;
            background: linear-gradient(135deg, #42b983, #369a6d);
            display: flex;
            align-items: center;
            justify-content: center;
            font-size: 28px;
