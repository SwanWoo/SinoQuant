      ...
      <el-col :span="4">
        <el-card class="config-menu" shadow="never">
          ...
          >
            ...
            <el-menu-item index="vendor-configs">
        ...
        <el-card v-show="activeTab === 'system'" class="config-content" shadow="never">
          ...
          <el-form :model="systemSettings" label-width="150px" v-loading="systemLoading">
              ...
              >
                ...
                >
                  <div style="display: flex; flex-direction: column;">
                    ...
                    <span style="font-size: 12px; color: var(--el-text-color-secondary);">{{ model.model_name }}</span>
                  </div>
                </el-option>
              </el-select>
              <div class="setting-description">用于市场分析、新闻分析、基本面分析、研究员等，响应速度快（推荐：deepseek-flash）</div>
            </el-form-item>
            ...
            <el-form-item label="深度决策模型">
              ...
              <div class="setting-description">用于研究管理者综合决策、风险管理者最终评估，推理能力强（推荐：deepseek-v4-pro）</div>
            </el-form-item>
            ...
            <el-form-item label="Worker 心跳间隔">
              ...
              <el-tooltip effect="dark" content="Worker 心跳上报周期；过小会增加负载，过大可能影响健康检查" placement="top">
                <i class="el-icon-info" style="margin-left:8px; color:var(--el-text-color-secondary);" />
              </el-tooltip>
            </el-form-item>
            ...
            <!-- SinaQuant（可选） -->
            <el-divider content-position="left">SinaQuant（可选）</el-divider>
...
const handleMenuSelect = (index: string) => {
  if (index === 'vendor-configs') {
    router.push('/settings/vendor-configs')
    return
  }
...
const exportConfig = async () => {
  ...
  try {
    ...
    link.href = url
    link.download = `sinoquant-config-${new Date().toISOString().split('T')[0]}.json`
    link.click()
