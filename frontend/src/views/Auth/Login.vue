  ...
  <div class="login-page">
    <div class="login-container">
      ...
      <div class="login-footer">
        ...
        <p class="disclaimer">
          SinaQuant 是一个 AI 多 Agents 的股票分析学习平台。平台中的分析结论、观点和“投资建议”均由 AI 自动生成，仅用于学习、研究与交流，不构成任何形式的投资建议或承诺。用户据此进行的任何投资行为及其产生的风险与后果，均由用户自行承担。市场有风险，入市需谨慎。
        </p>
      </div>
    </div>
  </div>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (success) {
      ...
      // 管理员默认跳转到管理面板
      const targetPath = authStore.isAdmin ? '/admin' : redirectPath
