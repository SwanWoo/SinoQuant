...
export const configApi = {
  ...
  // 获取所有大模型配置
  getLLMConfigs(params?: { include_all?: boolean }): Promise<LLMConfig[]> {
    return ApiClient.get('/api/config/llm', params)
  },
 ...
 * 添加新数据源时，请先在后端 sinoquant/constants/data_sources.py 中注册
 */
