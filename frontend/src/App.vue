...
.global-loading {
  ...
  z-index: 9999;
  height: 2px;
  background: linear-gradient(90deg, #42b983 0%, #68c99e 40%, #369a6d 100%);
}
...
// Dark mode: force all link/text buttons to have visible text colors
html.dark .el-button.is-link {
  color: #c8c8c8 !important;
  --el-button-text-color: #c8c8c8 !important;
  -webkit-text-fill-color: #c8c8c8 !important;
}
html.dark .el-button.is-link:hover { color: #42b983 !important; }
html.dark .el-button--primary.is-link { color: #42b983 !important; --el-button-text-color: #42b983 !important; -webkit-text-fill-color: #42b983 !important; }
html.dark .el-button--primary.is-link:hover { color: #68c99e !important; }
html.dark .el-button--success.is-link { color: #42b983 !important; --el-button-text-color: #42b983 !important; -webkit-text-fill-color: #42b983 !important; }
html.dark .el-button--success.is-link:hover { color: #7dd4a0 !important; }
html.dark .el-button--warning.is-link { color: #e6a23c !important; --el-button-text-color: #e6a23c !important; -webkit-text-fill-color: #e6a23c !important; }
html.dark .el-button--warning.is-link:hover { color: #f0b956 !important; }
html.dark .el-button--danger.is-link { color: #f56c6c !important; --el-button-text-color: #f56c6c !important; -webkit-text-fill-color: #f56c6c !important; }
html.dark .el-button--danger.is-link:hover { color: #f89b9b !important; }
html.dark .el-button--info.is-link { color: #b0b3b8 !important; --el-button-text-color: #b0b3b8 !important; -webkit-text-fill-color: #b0b3b8 !important; }
html.dark .el-button--info.is-link:hover { color: #c8cacf !important; }
html.dark .el-button.is-text { color: #c8c8c8 !important; --el-button-text-color: #c8c8c8 !important; -webkit-text-fill-color: #c8c8c8 !important; }
html.dark .el-button--primary.is-text { color: #42b983 !important; --el-button-text-color: #42b983 !important; -webkit-text-fill-color: #42b983 !important; }
html.dark .el-button--danger.is-text { color: #f56c6c !important; --el-button-text-color: #f56c6c !important; -webkit-text-fill-color: #f56c6c !important; }
