...
const initApp = async () => {
  try {
    ...
    // 🔥 暗色模式按钮文字修复 — 运行时注入最高优先级样式
    injectDarkModeButtonFix()
  }
}

// 运行时注入暗色模式按钮修复样式（绕过所有 CSS 级联问题）
function injectDarkModeButtonFix() {
  const styleId = 'dark-button-fix'
  ...
  style.textContent = `
    ...
    html.dark .el-button--success.is-text,
    html.dark .el-button--success.is-plain {
      color: #42b983 !important;
      -webkit-text-fill-color: #42b983 !important;
    }
    html.dark .el-button--warning.is-link,
    html.dark .el-button--warning.is-text,
    html.dark .el-button--warning.is-plain {
      color: #e6a23c !important;
      -webkit-text-fill-color: #e6a23c !important;
    }
    html.dark .el-button--danger.is-link,
    html.dark .el-button--danger.is-text,
    html.dark .el-button--danger.is-plain {
      color: #f56c6c !important;
      -webkit-text-fill-color: #f56c6c !important;
    }
    html.dark .el-button--info.is-link,
    html.dark .el-button--info.is-text,
    html.dark .el-button--info.is-plain {
      color: #b0b3b8 !important;
      -webkit-text-fill-color: #b0b3b8 !important;
    }
    html.dark .el-button.is-link:hover,
...
if (import.meta.env.DEV) {
  console.log('🚀 SinaQuant v0.0.0-preview 前端应用已启动')
