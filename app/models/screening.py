...
class FieldInfo(BaseModel):
    """字段信息 — 筛选器中单个字段的元数据(名称/类型/统计值/支持的操作符)"""
...
class FieldStatistics(BaseModel):
    """字段统计信息 — 数值字段的分布统计(最小值/最大值/均值/标准差)"""
    field: str = Field(..., description="字段名")
