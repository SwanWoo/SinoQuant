...
from sinoquant.utils.text_utils import remove_thinking_content, sanitize_report_modules
...
class ReportExporter:
    ...
    def generate_markdown_report(self, report_doc: Dict[str, Any]) -> str:
        ...
        reports = sanitize_report_modules(report_doc.get("reports", {}))
        summary = remove_thinking_content(str(report_doc.get("summary", "") or "")).strip()
        ...
        content_parts.append("---")
        content_parts.append("")
        content_parts.append("*本报告由 SinaQuant 自动生成*")
        content_parts.append("")
