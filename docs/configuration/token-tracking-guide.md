...
本指南介绍如何配置和使用SinaQuant的Token使用统计和成本跟踪功能，包括v0.1.7新增的DeepSeek成本追踪和智能成本控制。

## 功能概述

SinaQuant提供了完整的Token使用统计和成本跟踪功能，包括：
...
# 数据库名称
MONGODB_DATABASE_NAME=sinoquant
```
...
```python
from sinoquant.llm_adapters.dashscope_adapter import ChatDashScope
...
```python
from sinoquant.config.config_manager import config_manager, PricingConfig
