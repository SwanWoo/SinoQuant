...
本指南介绍如何将 SinaQuant 绿色版从依赖系统 Python 的虚拟环境迁移到完全独立的嵌入式 Python。
...
```powershell
# 使用国内镜像
$pythonExe = "C:\SinaQuantCN\release\SinaQuantCN-portable\vendors\python\python.exe"
