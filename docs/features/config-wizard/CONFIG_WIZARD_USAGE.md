...
本文档介绍如何使用 SinaQuant 的配置向导和配置验证功能，帮助用户快速完成系统配置。
...
| MONGODB_DATABASE | MongoDB 数据库名称 | sinoquant |
...
开始使用 SinaQuant，享受智能股票分析的乐趣！🚀

---

**需要帮助？**

- 📧 提交 Issue: https://github.com/SinoQuant Project/SinaQuant/issues
- 📖 查看文档: `docs/` 目录
