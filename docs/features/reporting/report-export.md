...
SinaQuant 提供了强大的报告导出功能，支持将股票分析结果导出为多种专业格式，方便用户保存、分享和进一步分析。
...
3. **检查依赖**
   ...
   ```bash
   docker exec SinaQuant-web pandoc --version
   docker exec SinaQuant-web wkhtmltopdf --version
   ```
...
感谢他的杰出贡献，让SinaQuant拥有了专业级的报告导出能力！
