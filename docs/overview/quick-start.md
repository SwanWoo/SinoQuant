...
本指南将帮助您快速上手 SinaQuant 框架，从安装到运行第一个交易分析，只需几分钟时间。
...
```bash
# 使用 conda
conda create -n sinoquant python=3.13
conda activate sinoquant

# 或使用 venv
python -m venv sinoquant
source sinoquant/bin/activate  # Linux/macOS
# sinoquant\Scripts\activate  # Windows
```
...
如果遇到问题，可以：
- 查看 [常见问题](../faq/faq.md)
- 访问 [GitHub Issues](https://github.com/SinoQuant/SinaQuant/issues)
