...
> 5分钟快速上手 SinaQuant v0.0.0-preview
...
```powershell
# 1. 下载绿色版压缩包
# 2. 解压到任意目录（如 D:\SinaQuantCN-portable）
...
- 关注公众号 "SinaQuant" 获取网盘链接

操作手册：

https://mp.weixin.qq.com/s/uAk4RevdJHMuMvlqpdGUEw
SinaQuant v0.0.0-preview绿色版（目前只支持windows）简单使用手册
https://mp.weixin.qq.com/s/o5QdNuh2-iKkIHzJXCj7vQ
SinaQuant v0.0.0-preview绿色版绿色版端口配置说明
---
...
# 2. 创建项目目录
mkdir sinoquant-cn && cd sinoquant-cn
...
- **GitHub Issues**: [提交问题](https://github.com/SinoQuant Project/SinaQuant/issues)
- **微信公众号**: SinaQuant
- **QQ 群**: 关注公众号获取群号
