...
```bash
# 1. 克隆预览分支
git clone -b feature/deepseek-v3-integration https://github.com/SinoQuant Project/SinaQuant.git
cd SinaQuant
...
```bash
# 启用调试模式
export SINOQUANT_LOG_LEVEL=DEBUG
python tests/test_deepseek_token_tracking.py
```
...
# 测试数据获取
python -c "
from sinoquant.dataflows.tdx_utils import get_china_stock_data
...
- **实时反馈**：在Issue中@SinoQuant Project
