...
```bash
# 克隆项目到本地
git clone https://github.com/your-repo/SinaQuant.git
cd SinaQuant
...
# 验证安装
python -c "import sinoquant; print('安装成功!')"
```
...
# MongoDB配置
MONGODB_URI=mongodb://localhost:27017/sinoquant
...
```bash
# 测试Python环境
python -c "import sinoquant; print('✅ 模块导入成功')"

# 测试依赖包
python -c "import streamlit, pandas, yfinance; print('✅ 依赖包正常')"

# 测试配置文件
python -c "from sinoquant.config import get_config; print('✅ 配置加载成功')"
```
...
### 1. 模块导入错误
```bash
# 问题: ModuleNotFoundError: No module named 'sinoquant'
# 解决方案:
pip install -e .

# 或重新安装
pip uninstall sinoquant
pip install -e .
```
...
- **GitHub Issues**: [提交问题](https://github.com/your-repo/SinaQuant/issues)
- **文档**: [查看完整文档](../README.md)
