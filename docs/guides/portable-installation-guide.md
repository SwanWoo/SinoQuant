...
SinaQuant 绿色安装版是一个**免安装、开箱即用**的便携版本，无需复杂的环境配置，适合快速部署和测试。
...
1. 下载 `SinaQuantCN-Portable-vX.X.X.zip` 或 `.7z` 安装包
2. 解压到任意目录（建议路径不包含中文和空格）
   ```
   例如：D:\SinaQuantCN-portable
   ```
...
- **GitHub Issues**：https://github.com/yourusername/SinaQuantCN/issues
- **文档**：查看 `docs/` 目录下的详细文档
