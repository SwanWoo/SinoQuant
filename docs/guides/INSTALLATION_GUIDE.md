...
- **Redis管理**: http://localhost:8081 (用户名/密码: admin/sinoquant123)
...
### 官方资源
- **项目主页**: https://github.com/SinoQuant Project/SinaQuant
- **文档中心**: https://www.sinoquant.cn/
- **问题反馈**: https://github.com/SinoQuant Project/SinaQuant/issues
...
🎉 **恭喜！** 您已成功安装SinaQuant。开始您的AI股票分析之旅吧！
