...
本指南详细介绍了如何使用SinaQuantCN系统中的新闻获取和分析功能，帮助您获取实时新闻并进行专业分析，为投资决策提供重要参考。
...
```python
from sinoquant.dataflows.akshare_utils import get_stock_news_em
...
通过本指南，您应该能够熟练使用SinaQuantCN系统中的新闻分析功能，为您的投资决策提供重要参考。