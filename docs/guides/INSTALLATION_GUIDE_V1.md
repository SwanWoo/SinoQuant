...
- **GitHub Releases**: [https://github.com/SinoQuant Project/SinaQuant/releases](https://github.com/SinoQuant Project/SinaQuant/releases)
- **百度网盘**: 关注公众号 "SinaQuant" 获取下载链接
- **阿里云盘**: 关注公众号 "SinaQuant" 获取下载链接

文件名格式：`SinaQuantCN-Portable-v0.0.0-preview.zip` 或 `.7z`
...
2. **下载 docker-compose.yml**：
   ```bash
   # 从 GitHub 下载
   curl -O https://raw.githubusercontent.com/SinoQuant Project/SinaQuant/main/docker-compose.yml
...
3. **创建 .env 文件**：
   ```bash
   # 复制示例配置
   curl -O https://raw.githubusercontent.com/SinoQuant Project/SinaQuant/main/.env.example
   mv .env.example .env
...
1. **查看文档**: [docs/](../)
2. **GitHub Issues**: [https://github.com/SinoQuant Project/SinaQuant/issues](https://github.com/SinoQuant Project/SinaQuant/issues)
3. **微信公众号**: SinaQuant
4. **QQ 群**: 关注公众号获取群号
