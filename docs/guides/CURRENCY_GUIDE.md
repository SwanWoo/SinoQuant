...
SinaQuant 支持多种货币单位的模型定价，不同的 LLM 厂家使用不同的货币进行计费。

SinaQuant supports multiple currency units for model pricing. Different LLM providers use different currencies for billing.
...
- 📧 邮箱 / Email: SinoQuant@163.com
- 💬 QQ群 / QQ Group: 782124367
- 🌐 GitHub: https://github.com/SinoQuant Project/SinaQuant
