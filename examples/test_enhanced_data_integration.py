...
from sinoquant.dataflows.enhanced_data_adapter import get_enhanced_data_adapter
from sinoquant.dataflows.optimized_china_data import get_optimized_china_data_provider
...
def test_cache_mode_comparison():
    ...
    import sinoquant.dataflows.enhanced_data_adapter
    reload(sinoquant.dataflows.enhanced_data_adapter)
