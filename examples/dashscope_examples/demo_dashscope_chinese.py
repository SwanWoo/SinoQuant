...
def analyze_stock_with_chinese_output(stock_symbol="600036", analysis_date="2024-05-10"):
    """使用阿里百炼进行中文股票分析"""
    
    logger.info(f"🚀 SinaQuant 中文股票分析 - 阿里百炼版本")
    logger.info(f"=")
...
- 提供明确的投资建议"""
        ...
        user_prompt = f"""请对招商银行({stock_symbol})进行全面的股票分析。
...
def main():
    """主函数"""
    # 进行完整的股票分析
    result = analyze_stock_with_chinese_output("600036", "2024-05-10")
