#!/usr/bin/env python3
"""
SinaQuant 演示脚本 - 使用阿里百炼大模型（禁用记忆功能）
这个脚本展示了如何使用阿里百炼大模型运行 SinaQuant 框架，临时禁用记忆功能
"""
...
def main():
    """主函数"""
    logger.info(f"🚀 SinaQuant 演示 - 阿里百炼版本（无记忆）")
    logger.info(f"=")
